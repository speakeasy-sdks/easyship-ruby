...
module Easyship
  module Shared
    ...
    class OAuth2ClientCredentialsRequest < ::Easyship::Utils::FieldAugmented
      ...
      # OAuth 2 Grant Type
      field :grant_type, ::Easyship::Shared::OAuth2ClientCredentialsRequestGrantType, { 'format_json': { 'letter_case': ::Easyship::Utils.field_name('grant_type'), 'decoder': Utils.enum_from_string(::Easyship::Shared::OAuth2ClientCredentialsRequestGrantType, false) } }
      ...
      sig { params(client_id: ::String, client_secret: ::String, grant_type: ::Easyship::Shared::OAuth2ClientCredentialsRequestGrantType, scope: ::String).void }
