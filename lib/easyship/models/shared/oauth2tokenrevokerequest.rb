...
module Easyship
  module Shared
    ...
    class OAuth2TokenRevokeRequest < ::Easyship::Utils::FieldAugmented
      ...
      # OAuth 2 Grant Type
      field :grant_type, ::Easyship::Shared::GrantType, { 'format_json': { 'letter_case': ::Easyship::Utils.field_name('grant_type'), 'decoder': Utils.enum_from_string(::Easyship::Shared::GrantType, false) } }
      # OAuth 2 Access Token
      field :token, ::String, { 'format_json': { 'letter_case': ::Easyship::Utils.field_name('token') } }


      sig { params(client_id: ::String, client_secret: ::String, grant_type: ::Easyship::Shared::GrantType, token: ::String).void }
