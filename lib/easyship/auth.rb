...
module Easyship
  ...
  class Auth
    ...
    def introspect(request)
      ...
      res = ::Easyship::Operations::IntrospectTokenResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::Easyship::Shared::OAuth2IntrospectResponse)
    ...
    def retrieve(request)
      ...
      res = ::Easyship::Operations::RetrieveTokenResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::Easyship::Shared::OAuth2TokenResponse)
    ...
    def retrieve_info
      ...
      res = ::Easyship::Operations::RetrieveInfoResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::Easyship::Shared::OAuth2TokenInfo)
    ...
    def revoke(request)
      ...
      res = ::Easyship::Operations::RevokeTokenResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::Easyship::Shared::RevokeAccessTokenResponse)
